...
angular
  ...
  .constant('DASHBOARD', {
    ...
    INCOMPLETE:
      'If you do not complete your application before the [APP_DEADLINE], not be able to attend',
    ...
    CLOSED_AND_INCOMPLETE:
      'Because you have not completed your profile in time, you will not be eligible for the event.',
    ...
    DECLINED:
      "We're sorry to hear that you won't be able to make it to HackWITus 2019! :(\nMaybe next year! We hope you see you again soon."
  })
  .constant('TEAM', {
    NO_TEAM_REG_CLOSED:
      "Unfortunately, it's too late to register with a team.\nHowever, you can still form teams on your own before or during the event!"
  });
